...
export class HomePage {
  ...
  estados = [
    ...
    },
    {
      ...
      zonas: [
        { nombre: 'Zona arqueológica de Sierra de San Francisco', imagen: 'assets/img/bcs-img/sierra-san-fran-tbn.jpeg', ruta: '/sierra-de-san-francisco'},
      ],
      currentPage: 1,
      itemsPerPage: 1,
    },
    ...
    },
    {
      nombre: 'Chihuahua',
      zonas: [
        { nombre: 'Zona arqueológica de Cuarenta Casas', imagen: 'assets/img/chihuahua-img/cuarenta-casas-tbn.png', ruta: '/cuarenta-casas'},
        { nombre: 'Zona arqueológica de Cueva Grande', imagen: 'assets/img/chihuahua-img/cueva-grande-tbn.png', ruta: '/cueva-grande'},
        { nombre: 'Zona arqueológica de Cueva de la Olla', imagen: 'assets/img/chihuahua-img/cueva-de-la-olla-tbn.png', ruta: '/cueva-de-la-olla'},
        { nombre: 'Zona arqueológica de Huapoca', imagen: 'assets/img/chihuahua-img/huapoca-tbn.png', ruta: '/huapoca'},
        { nombre: 'Zona arqueológica de Paquime', imagen: 'assets/img/chihuahua-img/paquime-tbn.png', ruta: '/paquime'}
      ],
      currentPage: 1,
      itemsPerPage: 5,
    },
    ...
    },
    {
      nombre: 'Coahuila',
      zonas: [
        { nombre: 'Zona Paleontológica de Rincon Colorado', imagen: 'assets/img/coahuila-img/rincon-colorado-tbn.jpg', ruta: '/zona-paleontologica-rincon-colorado'},
      ],
      currentPage: 1,
      itemsPerPage: 1,
    },
    {
      nombre: 'Colima',
      zonas: [
        { nombre: 'Zona Arqueologica de La Campana', imagen: 'assets/img/colima-img/campana-tbn.png', ruta: '/la-campana'},
        { nombre: 'Zona Arqueologica de El Chanal', imagen: 'assets/img/colima-img/chanal-tbn.png', ruta: '/el-chanal'},
      ],
      currentPage: 1,
      itemsPerPage: 2,
    },
    ...
    },
    {
      nombre: 'Guanajuato',
      zonas: [
        { nombre: 'Zona Arqueologica de Arroyo Seco', imagen: 'assets/img/guanajuato-img/arroyo-seco-tbn.png', ruta: '/arroyo-seco'},
        { nombre: 'Zona Arqueologica Cañada de la Virgen', imagen: 'assets/img/guanajuato-img/canada-de-la-virgen-tbn.png', ruta: '/canada-de-la-virgen'},
        { nombre: 'Zona Arqueologica El Coporo', imagen: 'assets/img/guanajuato-img/coporo-tbn.png', ruta: '/el-coporo'},
        { nombre: 'Zona Arqueologica Peralta', imagen: 'assets/img/guanajuato-img/peralta-tbn.png', ruta: '/peralta'},
        { nombre: 'Zona Arqueologica Plazuelas', imagen: 'assets/img/guanajuato-img/plazuelas-tbn.png', ruta: '/plazuelas'}
      ],
      currentPage: 1,
      itemsPerPage: 5,
    },
    ...
    },
    {
      nombre: 'Jalisco',
      zonas: [
        { nombre: 'Zona Arqueologica de Ixtépete', imagen: 'assets/img/jalisco-img/ixtepete-tbn.png', ruta: '/ixtepete'},
        { nombre: 'Zona Arqueologica de Guachimontones', imagen: 'assets/img/jalisco-img/guachimontes-tbn.png', ruta: '/guachimontones'},
      ],
      currentPage: 1,
      itemsPerPage: 2,
    },

    {
      nombre: 'Michoacan',
      zonas: [
        { nombre: 'Zona Arqueologica de San Felipe Los Alzati', imagen: 'assets/img/michoacan-img/san-felipe-los-alzati-tbn.png', ruta: '/san-felipe-los-alzati'},
        { nombre: 'Zona Arqueologica de Huandacareo', imagen: 'assets/img/michoacan-img/huandacareo-tbn.png', ruta: '/huandacareo-la-nopalera'},
        { nombre: 'Zona Arqueologica Tres Cerritos', imagen: 'assets/img/michoacan-img/tres-cerritos-tbn.png', ruta: '/tres-cerritos'},
        { nombre: 'Zona Arqueologica de Tzintzuntzan', imagen: 'assets/img/michoacan-img/tzintzuntzan-tbn.png', ruta: '/tzintzuntzan'},
        { nombre: 'Zona Arqueologica de Ihuatzio', imagen: 'assets/img/michoacan-img/ihuatzio-tbn.png', ruta: '/ihuatzio'},
        { nombre: 'Zona Arqueologica de Tingambato', imagen: 'assets/img/michoacan-img/tingambato-tbn.png', ruta: '/tingambato'}
      ],
      currentPage: 1,
      itemsPerPage: 6,
    },
    ...
    },
    {
      nombre: 'Nayarit',
      zonas: [
        { nombre: 'Zona Arqueologica Ixtlán del Rio', imagen: 'assets/img/nayarit-img/ixtlan-rio-tbn.jpg', ruta: '/ixtlan-del-rio'},
      ],
      currentPage: 1,
      itemsPerPage: 1,
    },
    ...
    },
    {
      ...
      zonas: [
        { nombre: 'Zona Arqueologica de Tamohi', imagen: 'assets/img/slp-img/tamohi-hr.png', ruta: '/tamohi'},
        { nombre: 'Zona Arqueologica de Tamtoc', imagen: 'assets/img/slp-img/tamtoc.jpeg', ruta: '/tamtoc'},
      ],
      currentPage: 1,
      itemsPerPage: 2,
    },
    ...
    },
    {
      nombre: 'Tamaulipas',
      zonas: [
        { nombre: 'Zona Arqueologica de Balcón de Moctezuma', imagen: 'assets/img/tamaulipas-img/balcon-moctezuma-tbn.png', ruta: '/balcon-de-moctezuma'},
        { nombre: 'Zona Arqueologica El Sabinito', imagen: 'assets/img/tamaulipas-img/el-sabinito-tbn.png', ruta: '/el-sabinito'},
        { nombre: 'Zona Arqueologica Las Flores', imagen: 'assets/img/tamaulipas-img/las-flores-tbn.png', ruta: '/las-flores'},
      ],
      currentPage: 1,
      itemsPerPage: 3,
    },
    {
      nombre: 'Tlaxcala',
      zonas: [
        { nombre: 'Zona Arqueologica de Cacaxtla', imagen: 'assets/img/tlaxcala-img/cacaxtla-tbn.png', ruta: '/cacaxtla'},
        { nombre: 'Zona Arqueologica de Ocotelulco', imagen: 'assets/img/tlaxcala-img/ocotelulco-tbn.png', ruta: '/ocotelulco'},
        { nombre: 'Zona Arqueologica de Tizatlán', imagen: 'assets/img/tlaxcala-img/tizatlan-tbn.png', ruta: '/tizatlan'},
        { nombre: 'Zona Arqueologica de Tecoaque', imagen: 'assets/img/tlaxcala-img/tecoaque-tbn.png', ruta: '/tecoaque'},
      ],
      currentPage: 1,
      itemsPerPage: 5,
    },
    ...
    },
    {
      nombre: 'Zacatecas',
      zonas: [
        { nombre: 'Zona Arqueologica de Alta Vista Chalchihuites', imagen: 'assets/img/zacatecas-img/altavista-tbn.png', ruta: '/alta-vista-chalchihuites'},
        { nombre: 'Zona Arqueologica de Cerro de las Ventanas', imagen: 'assets/img/zacatecas-img/cerro-ventana-tbn.png', ruta: '/cerro-de-las-ventanas'},
        { nombre: 'Zona Arqueologica de La Quemada', imagen: 'assets/img/zacatecas-img/la-quemada-tbn.png', ruta: '/la-quemada'}
      ],
      currentPage: 1,
      itemsPerPage: 5,
    },
